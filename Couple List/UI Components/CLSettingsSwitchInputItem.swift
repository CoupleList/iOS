...
class CLSettingsSwitchInputItem: UIView {
    ...
    fileprivate let inputSwitch: UISwitch = {
        let s = UISwitch()
        s.translatesAutoresizingMaskIntoConstraints = false
        s.onTintColor = UIColor.init(named: "MainColor")
        s.isOn = false
        return s
    }()
    ...
    fileprivate func setupView() {
        ...
        inputSwitch.rightAnchor.constraint(equalTo: safeAreaLayoutGuide.rightAnchor, constant: -10).isActive = true
        inputSwitch.centerYAnchor.constraint(equalTo: iconImageView.centerYAnchor).isActive = true
        ...
        titleLabel.rightAnchor.constraint(equalTo: inputSwitch.leftAnchor, constant: -10).isActive = true
        ...
        detailsLabel.rightAnchor.constraint(equalTo: inputSwitch.leftAnchor, constant: -10).isActive = true
    }
}
